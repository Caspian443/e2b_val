...
const (
	...
	// UFFD_FEATURE_WP_HUGETLBFS_SHMEM is only available in Linux 5.19+
	// For older kernels, we define it manually to avoid compilation errors
	UFFD_FEATURE_WP_HUGETLBFS_SHMEM = 1 << 11
)
